...
import static com.sijanstu.recurlytics.components.ToastClientProperties.*;
...
public class ToastPanelUI extends BasicPanelUI implements StyleableUI, PropertyChangeListener {
    ...
    protected void installDefaults(JPanel p) {
        ...
        closeButtonIcon = UIUtils.getIcon(prefix + ".closeIcon", UIUtils.createIcon("assets/svg/close.svg", closeIconColor, 0.75f));
