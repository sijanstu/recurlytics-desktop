...
public class Notifications {
    ...
    public static Notifications getInstance() {
        if (instance == null) {
            ...
            instance.setJFrame(FormsManager.getInstance().getFrame());
        }
        return instance;
    }
    public static Notifications getInstance(JFrame frame) {
        if (instance == null) {
            instance = new Notifications();
            instance.setJFrame(frame);
        }
        return instance;
    }
    ...
    public void show(Type type, String message) {
        show(type, Location.BOTTOM_RIGHT, message);
    }

    public void show(Type type, long duration, String message) {
        show(type, Location.BOTTOM_RIGHT, duration, message);
    }
    ...
    public void show(JComponent component) {
        show(Location.BOTTOM_RIGHT, component);
    }
