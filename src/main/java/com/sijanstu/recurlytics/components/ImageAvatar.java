...
public class ImageAvatar extends JComponent {
    ...
    //on hover
    int backUpBorderSize;
    int backUpBorderSpace;
    boolean isHover = false;
    public void setHover(boolean hover) {
        //make border bigger
        if (hover&&!isHover) {
            backUpBorderSize = borderSize;
            backUpBorderSpace = borderSpace;
            borderSize = 8;
            borderSpace = 3;
            isHover = true;
        } else if (!hover&&isHover) {
            borderSize = backUpBorderSize;
            borderSpace = backUpBorderSpace;
            isHover = false;
        }
        repaint();
    }
